...
ln -s --relative  {self._exp_dir_slurm}/output_record/"$SLURM_ARRAY_JOB_ID"_"$SLURM_ARRAY_TASK_ID".out  $1/$SLURM_ARRAY_TASK_ID/"$SLURM_ARRAY_JOB_ID"_"$SLURM_ARRAY_TASK_ID".out 
ln -s --relative  {self._exp_dir_slurm}/output_record/"$SLURM_ARRAY_JOB_ID"_"$SLURM_ARRAY_TASK_ID".err  $1/$SLURM_ARRAY_TASK_ID/"$SLURM_ARRAY_JOB_ID"_"$SLURM_ARRAY_TASK_ID".err 
ln -s --relative  $1/$SLURM_ARRAY_TASK_ID/success_record.csv  {self._exp_dir_slurm}/success_record/"$SLURM_ARRAY_JOB_ID"_"$SLURM_ARRAY_TASK_ID".csv
